...
<script>
    export default {
        ...
        methods: {
            initECharts_bar_top() {
                let top_right_ECharts_ri1 = this.$echarts.init(document.getElementById("top_right_ECharts_ri1"));
            ...
            initECharts_bar_center() {
                let top_right_ECharts_ri2 = this.$echarts.init(document.getElementById("top_right_ECharts_ri2"));
