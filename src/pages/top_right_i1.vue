...
<script>
    export default {
        ...
        methods: {
            ...
            initECharts_bar_top() {
                let top_right_ECharts_li1 = this.$echarts.init(document.getElementById("top_right_ECharts_li1"));
            ...
            initECharts_bar_center() {
                let top_right_ECharts_li2 = this.$echarts.init(document.getElementById("top_right_ECharts_li2"));
            ...
            init_ECharts_funnel() {
                let top_right_ECharts_li3 = this.$echarts.init(document.getElementById('top_right_ECharts_li3'));
                let option = {
                    series: [
                        {
                            name: '漏斗图',
    ...
    .con {
        ...
        .bottom {
            ...
            .title_ECharts > p > span:first-child {
                ...
                color: white;
                font-weight: 700;
                background: url("../assets/img/icon9.png") no-repeat;
                background-size: 0.9375em;
            }
